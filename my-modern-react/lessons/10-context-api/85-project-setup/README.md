...
## To run in dev mode:
```bash
cd my-modern-react/my-lessons/10-context-api/85-project-setup/shopping-cart-ui
npm install
npm run dev
```

## NOTE: Project Initial Setup
- In video, mentions installing react-icons, but not mentioned here
```bash
npm i react-icons
```
...
---
[10-context-api-shopping-cart-project/03-project-setup.md]
# Project Setup
