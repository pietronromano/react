# 90. Cart Context
References:
- https://www.udemy.com/course/modern-react-from-the-beginning/learn/lecture/51287137#overview


## To run in dev mode:
```bash
cd my-modern-react/my-lessons/10-context-api/90-cart-context/shopping-cart-ui
npm install
npm run dev
```
...
---
# Cart Context
[10-context-api-shopping-cart-project/08-cart-context.md]
