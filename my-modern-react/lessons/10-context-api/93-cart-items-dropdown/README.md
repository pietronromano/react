...
References:
- https://www.udemy.com/course/modern-react-from-the-beginning/learn/lecture/51287145#overview

### Run JSON Server:
```bash
cd my-modern-react/my-lessons/10-context-api/93-cart-items-dropdown/shopping-cart-ui
npm run json-server 
...
---
# Cart Item Dropdown
[10-context-api-shopping-cart-project/10-cart-item-drop-down.md]
