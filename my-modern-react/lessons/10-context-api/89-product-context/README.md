# 89. Product Context
References:
- https://www.udemy.com/course/modern-react-from-the-beginning/learn/lecture/51287133#overview


## To run in dev mode:
```bash
cd my-modern-react/my-lessons/10-context-api/89-product-context/shopping-cart-ui
npm install
npm run dev
```
...
---
# Products Context
[10-context-api-shopping-cart-project/07-products-context.md]
...
[HERE HE FORGOT THE export, SO ADD IT]
```javascript
