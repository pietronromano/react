...
References:
- https://www.udemy.com/course/modern-react-from-the-beginning/learn/lecture/51287151#overview

### Run JSON Server:
```bash
cd my-modern-react/my-lessons/10-context-api/94-remove-clear-items/shopping-cart-ui
npm install
npm run json-server 
...
---
# Remove From Cart
[10-context-api-shopping-cart-project/11-remove-items-and-clear-cart.md]
