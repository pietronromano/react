...
References:
- https://www.udemy.com/course/modern-react-from-the-beginning/learn/lecture/51287141#overview
...
```bash
cd my-modern-react/my-lessons/10-context-api/92-header-cart-count/shopping-cart-ui
npm install
npm run json-server 
...
[10-context-api-shopping-cart-project/09-header-with-cart-item-count.md]
