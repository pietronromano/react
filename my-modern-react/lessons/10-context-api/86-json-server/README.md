...
- https://www.udemy.com/course/modern-react-from-the-beginning/learn/lecture/51287069#overview


## To run in dev mode:
```bash
cd my-modern-react/my-lessons/10-context-api/86-json-server/shopping-cart-ui
npm install
npm run dev
```
...
---
# JSON Server Setup
[10-context-api-shopping-cart-project/04-json-server-setup.md ]
