...
References:
- my-modern-react/docs/04-forms-and-input-notes-app/05-form-submission-and-global-state.md
- https://www.udemy.com/course/modern-react-from-the-beginning/learn/lecture/51273913#overview
- 
## To run in development mode:
```bash
cd my-modern-react/lessons/04-forms-inputs/41-form-submission/notes-app
npm install
npm run dev
```
...
<img src="../../../docs/images/devtools-3.png" width="500" />
