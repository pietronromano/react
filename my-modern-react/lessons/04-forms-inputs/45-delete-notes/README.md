# 45. Delete Notes
References:
- 04-forms-and-input-notes-app/09-delete-notes.md
- https://www.udemy.com/course/modern-react-from-the-beginning/learn/lecture/51273929#overview
  
## To run in development mode:
```bash
cd my-modern-react/lessons/04-forms-inputs/45-delete-notes/notes-app
npm install
npm run dev
```
