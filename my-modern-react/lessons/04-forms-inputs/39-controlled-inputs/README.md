# Controlled Inputs
References:
- my-modern-react/docs/04-forms-and-input-notes-app/03-controlled-inputs.md
- https://www.udemy.com/course/modern-react-from-the-beginning/learn/lecture/51273901#overview
- https://react.dev/reference/react-dom/components/input#controlling-an-input-with-a-state-variable
 
## To run in development mode:
```bash
cd my-modern-react/lessons/04-forms-inputs/39-controlled-inputs/notes-app
npm install
npm run dev
```
