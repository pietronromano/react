...
References:
- 04-forms-and-input-notes-app/10-conditional-rendering-challenge.md
- https://www.udemy.com/course/modern-react-from-the-beginning/learn/lecture/51273933#overview
  
## To run in development mode:
```bash
cd my-modern-react/lessons/04-forms-inputs/46-conditional-rendering/notes-app
npm install
npm run dev
```
