# 40-form-data-object
References:
- my-modern-react/docs/04-forms-and-input-notes-app/04-form-data-object.md
- https://www.udemy.com/course/modern-react-from-the-beginning/learn/lecture/51273907#overview
 
## To run in development mode:
```bash
cd my-modern-react/lessons/04-forms-inputs/40-form-data-object/notes-app
npm install
npm run dev
```
