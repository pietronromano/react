...
References:
- 04-forms-and-input-notes-app/08-reusable-input-components.md
- https://www.udemy.com/course/modern-react-from-the-beginning/learn/lecture/51273927#overview
  
## To run in development mode:
```bash
cd my-modern-react/lessons/04-forms-inputs/44-reusable-inputs/notes-app
npm install
npm run dev
```
