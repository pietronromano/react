# 47. Prop Drilling
References:
- https://www.udemy.com/course/modern-react-from-the-beginning/learn/lecture/51273937#overview
- 

***Prop drilling*** is a term used to describe the process of passing data from a parent component to a child component through props, and then passing it down to further child components. This can lead to a situation where props are passed through multiple layers of components that do not need the data, just to get it to the component that does.
  
## To run in development mode:
```bash
cd my-modern-react/lessons/04-forms-inputs/47-prop-drilling/notes-app
npm install
npm run dev
```
