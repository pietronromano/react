...
References:
- https://www.udemy.com/course/modern-react-from-the-beginning/learn/lecture/51286643#overview
- 07-working-with-apis-crypto-dash/03-making-http-requests.md
...
```bash
cd my-modern-react/my-lessons/07-apis-useEffect/62-http-requests/crypto-dash
npm install
npm run dev
```
