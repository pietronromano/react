...
References:
- https://www.udemy.com/course/modern-react-from-the-beginning/learn/lecture/51286647#overview
- 07-working-with-apis-crypto-dash/04-async-await-in-useeffect.md



## To run in development mode:
```bash
cd my-modern-react/my-lessons/07-apis-useEffect/63-async-await/crypto-dash
npm install
npm run dev
```
