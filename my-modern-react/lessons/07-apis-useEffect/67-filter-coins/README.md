# 66. Limit Selector
References:
- https://www.udemy.com/course/modern-react-from-the-beginning/learn/lecture/51286671#overview
- 07-working-with-apis-crypto-dash/08-filter-coins.md



## To run in development mode:
```bash
cd my-modern-react/my-lessons/07-apis-useEffect/67-filter-coins/crypto-dash
npm install
npm run dev
```
