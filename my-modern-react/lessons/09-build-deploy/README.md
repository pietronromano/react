# Build and Deploy React App with Vite
References:
- https://www.udemy.com/course/modern-react-from-the-beginning/learn/lecture/51286917#overview
- 09-build-and-deploy/02-understanding-the-build-process.md
- 09-build-and-deploy/03-the-build-command.md
- 09-build-and-deploy/04-deploying-to-vercel.md


## To run in BUILD mode:
```bash
cd my-modern-react/my-lessons/09-build-deploy/crypto-dash
npm install
npm run build
npm run preview
```
