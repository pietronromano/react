...
References:
- https://www.udemy.com/course/modern-react-from-the-beginning/learn/lecture/51286407#overview
- 06-useRef-hook-simple-timer-app/03-useRef-in-action.md

## To run in development mode:
```bash
cd my-modern-react/lessons/06-useRef/55-useRef-uncontrolled/hello-useref
npm install
npm run dev
```
