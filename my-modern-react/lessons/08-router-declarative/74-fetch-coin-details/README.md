...
References:
- https://www.udemy.com/course/modern-react-from-the-beginning/learn/lecture/51286771#overview
- 08-intro-to-routing-react-router-declarative-mode/06-fetch-coin-details.md

## To run in development mode:
```bash
cd my-modern-react/my-lessons/08-router-declarative/74-fetch-coin-details/crypto-dash
npm install
npm run dev
```
