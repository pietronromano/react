...
References:
- https://www.udemy.com/course/modern-react-from-the-beginning/learn/lecture/51286773#overview
- 08-intro-to-routing-react-router-declarative-mode/07-display-coin-data.md

## To run in development mode:
```bash
cd my-modern-react/my-lessons/08-router-declarative/75-display-coin-data/crypto-dash
npm install
npm run dev
```
