...
References:
- https://www.udemy.com/course/modern-react-from-the-beginning/learn/lecture/51286781#overview
  
## To run in development mode:
```bash
cd my-modern-react/my-lessons/08-router-declarative/77-get-chart-data/crypto-dash
npm install
npm run dev
```
...
---
# Adding Charts
[08-intro-to-routing-react-router-declarative-mode/09-get-and-format-chart-data.md]
...
Now, let's create a new component at `src/components/CoinChart.jsx` that will render a chart.
...
Add the following to the `CoinChart.jsx` file:
