# 71. Homepage Route
References:
- https://www.udemy.com/course/modern-react-from-the-beginning/learn/lecture/51286763#overview
- 08-intro-to-routing-react-router-declarative-mode/03-setup-and-homepage-route.md

## To run in development mode:
```bash
cd my-modern-react/my-lessons/08-router-declarative/71-homepage/crypto-dash
npm install
npm run dev
```
