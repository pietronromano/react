# 73. Not Found Page
References:
- https://www.udemy.com/course/modern-react-from-the-beginning/learn/lecture/51286767#overview
- 08-intro-to-routing-react-router-declarative-mode/05-not-found-route.md

## To run in development mode:
```bash
cd my-modern-react/my-lessons/08-router-declarative/73-not-found-page/crypto-dash
npm install
npm run dev
```
