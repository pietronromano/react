...
References:
- https://www.udemy.com/course/modern-react-from-the-beginning/learn/lecture/51287507#overview
...
Run:
```bash
cd my-modern-react/my-lessons/11-router-framework/100-ssr-vs-client/friendly-dev
npm install
npm run dev
```
...
[/docs/11-react-router-framework-mode-friendly-dev/04-ssr-vs-client.md]
