...
References:
- https://www.udemy.com/course/modern-react-from-the-beginning/learn/lecture/51287535#overview
...
Run:
```bash
cd my-modern-react/my-lessons/11-router-framework/106-layout-routes/friendly-dev
npm install
npm run dev
```
