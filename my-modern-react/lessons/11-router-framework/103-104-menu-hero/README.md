# 103. Responsive Menu, 104. Hero Component 

References:
- https://www.udemy.com/course/modern-react-from-the-beginning/learn/lecture/51287527#overview
- https://www.udemy.com/course/modern-react-from-the-beginning/learn/lecture/51287529#overview
...
Run:
```bash
cd my-modern-react/my-lessons/11-router-framework/103-104-menu-hero/friendly-dev
npm install
npm run dev
```
...
[/docs/11-react-router-framework-mode-friendly-dev/09-responsive-menu.md]
