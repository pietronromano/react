# 52. Local Storage & Side Effects
References:
- 05-lifecycle-and-useeffect-hook/05-local-storage-sideeffect.md
- https://www.udemy.com/course/modern-react-from-the-beginning/learn/lecture/51286261#overview


## To run in development mode:
```bash
cd my-modern-react/lessons/05-lifecycle-useEffect/52-localStorage/notes-app
npm install
npm run dev
```
