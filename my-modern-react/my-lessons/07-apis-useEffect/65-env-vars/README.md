...
References:
- https://www.udemy.com/course/modern-react-from-the-beginning/learn/lecture/51286661#overview
- 07-working-with-apis-crypto-dash/06-environment-variables.md



## To run in development mode:
```bash
cd my-modern-react/my-lessons/07-apis-useEffect/65-env-vars/crypto-dash
npm install
npm run dev
```
