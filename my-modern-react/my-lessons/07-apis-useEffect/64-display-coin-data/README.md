...
References:
- https://www.udemy.com/course/modern-react-from-the-beginning/learn/lecture/51286651#overview
- 07-working-with-apis-crypto-dash/05-display-coin-data.md



## To run in development mode:
```bash
cd my-modern-react/my-lessons/07-apis-useEffect/64-display-coin-data/crypto-dash
npm install
npm run dev
```
