# 66. Limit Selector
References:
- https://www.udemy.com/course/modern-react-from-the-beginning/learn/lecture/51286669#overview
- 07-working-with-apis-crypto-dash/07-limit-select.md



## To run in development mode:
```bash
cd my-modern-react/my-lessons/07-apis-useEffect/66-limit-selector/crypto-dash
npm install
npm run dev
```
