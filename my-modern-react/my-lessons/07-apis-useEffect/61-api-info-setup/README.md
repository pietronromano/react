...
References:
- https://www.udemy.com/course/modern-react-from-the-beginning/learn/lecture/51286629#overview
- 07-working-with-apis-crypto-dash/02-api-info-and-project-setup.md

## To run in development mode:
```bash
cd my-modern-react/my-lessons/07-apis-useEffect/61-api-info-setup
npm install
npm run dev
```
