# 66. Limit Selector
References:
- https://www.udemy.com/course/modern-react-from-the-beginning/learn/lecture/51286675#overview
- 07-working-with-apis-crypto-dash/09-sort-selector.md
...
```bash
cd my-modern-react/my-lessons/07-apis-useEffect/68-sort-order/crypto-dash
npm install
npm run dev
```
