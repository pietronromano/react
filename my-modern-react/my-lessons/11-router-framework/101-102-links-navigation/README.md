# 101. Links & Navigation, 102. Active Link Styling

Included Active Links Styling lesson for brevity.

References:
- https://www.udemy.com/course/modern-react-from-the-beginning/learn/lecture/51287517#overview
- https://www.udemy.com/course/modern-react-from-the-beginning/learn/lecture/51287525#overview
...
Run:
```bash
cd my-modern-react/my-lessons/11-router-framework/101-links-navigation/friendly-dev
npm install
npm run dev
```
...
# Links & Navigation
[/docs/11-react-router-framework-mode-friendly-dev/05-links-and-navigation.md]
