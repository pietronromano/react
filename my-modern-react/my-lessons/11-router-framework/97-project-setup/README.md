...
- React Router v7 (Framework Mode): in Chrome DevTools -> Components, checkout the complex structure of React Router
- TypeScript
- Server Side Rendering (SSR): see the meta tags in the root.tsx file
- Tailwind CSS.

References:
- https://reactrouter.com/home
- https://www.udemy.com/course/modern-react-from-the-beginning/learn/lecture/51287489#overview

---

## Initialize the project with React Router v7
```bash
cd my-modern-react/my-lessons/11-router-framework/97-project-setup
...
```bash
cd cd my-modern-react/my-lessons/11-router-framework/97-project-setup/friendly-dev
npm run dev
```
