...
References:
- https://www.udemy.com/course/modern-react-from-the-beginning/learn/lecture/51287491#overview
...
Run:
```bash
cd my-modern-react/my-lessons/11-router-framework/98-creating-routes/friendly-dev
npm install
npm run dev
```
...
# Creating Routes
[/docs/11-react-router-framework-mode-friendly-dev/03-creating-routes.md]
