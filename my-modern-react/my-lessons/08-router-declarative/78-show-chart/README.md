# 78. Show Chart
References:
- https://www.udemy.com/course/modern-react-from-the-beginning/learn/lecture/51286783#overview
  
## To run in development mode:
```bash
cd my-modern-react/my-lessons/08-router-declarative/78-show-chart/crypto-dash
npm install
npm run dev
```
...
---
# Show Chart Data
[08-intro-to-routing-react-router-declarative-mode/10-show-chart-data.md]
