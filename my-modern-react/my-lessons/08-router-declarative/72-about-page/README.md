...
References:
- https://www.udemy.com/course/modern-react-from-the-beginning/learn/lecture/51286765#overview
- 08-intro-to-routing-react-router-declarative-mode/04-about-page.md

## To run in development mode:
```bash
cd my-modern-react/my-lessons/08-router-declarative/72-about-page/crypto-dash
npm install
npm run dev
```
