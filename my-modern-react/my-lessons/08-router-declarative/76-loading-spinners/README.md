...
References:
- https://www.udemy.com/course/modern-react-from-the-beginning/learn/lecture/51286777#overview
  
## To run in development mode:
```bash
cd my-modern-react/my-lessons/08-router-declarative/76-loading-spinners/crypto-dash
npm install
npm run dev
```
...
---
# Add Spinners
[08-intro-to-routing-react-router-declarative-mode/08-add-spinner.md]
