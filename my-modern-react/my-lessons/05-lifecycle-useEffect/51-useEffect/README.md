# 51. Lifecycle With useEffect Hook
References:
- https://www.udemy.com/course/modern-react-from-the-beginning/learn/lecture/51286251#overview
- 05-lifecycle-and-useeffect-hook/04-lifecycle-useEffect-hook.md


## NOTE: Why Is My useEffect Running Twice?
...
```bash
cd my-modern-react/lessons/05-lifecycle-useeffect/51-useeffect/playground
npm install
npm run dev
```
