# 87. Display Products
References:
- https://www.udemy.com/course/modern-react-from-the-beginning/learn/lecture/51287119#overview


## To run in dev mode:
```bash
cd my-modern-react/my-lessons/10-context-api/87-display-products/shopping-cart-ui
npm install
npm run dev
```
