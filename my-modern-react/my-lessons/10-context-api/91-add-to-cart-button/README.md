...
References:
- https://www.udemy.com/course/modern-react-from-the-beginning/learn/lecture/51287139#overview


## To run in dev mode:
```bash
cd my-modern-react/my-lessons/10-context-api/91-add-to-cart-button/shopping-cart-ui
npm install
npm run dev
```
...
---
# Add To Cart Button
[10-context-api-shopping-cart-project/09-add-to-cart-button.md]
