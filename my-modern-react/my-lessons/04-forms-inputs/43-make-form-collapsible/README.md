# 42. Show Notes
References:
- 04-forms-and-input-notes-app/07-make-form-collapsible.md
- https://www.udemy.com/course/modern-react-from-the-beginning/learn/lecture/51273919#overview
  
## To run in development mode:
```bash
cd my-modern-react/lessons/04-forms-inputs/43-make-form-collapsible/notes-app
npm install
npm run dev
```
