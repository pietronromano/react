...
References:
- https://www.udemy.com/course/modern-react-from-the-beginning/learn/lecture/51286429#overview
- 06-useRef-hook-simple-timer-app/05-component-composition-challenge.md

## To run in development mode:
```bash
cd my-modern-react/lessons/06-useRef/57-component-composition/simple-timer
npm install
npm run dev
```
